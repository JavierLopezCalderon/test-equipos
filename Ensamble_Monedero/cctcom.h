...
#define sbegin(baud) Serial2.begin(baud)
#define srend() Serial2.end()
#define savailable() (Serial2.available() > 0)
#define sread() Serial2.read()
#define swrite(dta) Serial2.write(dta)
#else
